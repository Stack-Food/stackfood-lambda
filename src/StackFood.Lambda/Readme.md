...
WORKDIR /src
COPY ["StackFood.Lambda.csproj", "StackFood.Lambda/"]
RUN dotnet restore "StackFood.Lambda/StackFood.Lambda.csproj"

WORKDIR "/src/StackFood.Lambda"
COPY . .
RUN dotnet build "StackFood.Lambda.csproj" --configuration Release --output /app/build
...
Execute unit tests
```
cd "StackFood.Lambda/test/StackFood.Lambda.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "StackFood.Lambda/src/StackFood.Lambda"
